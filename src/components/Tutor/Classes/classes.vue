...
<v-layout row>
    ...
    <v-flex xs12 sm12 md12>
        <h1 style="text-align:center;" class="font-weight-light">Classes</h1>
        <br>
        ...
        <v-container>
            ...
            <v-layout row wrap v-if="courses.length > 0">
                <v-flex v-for="c in courses" :key="c.code" xs12 sm4 class="px-3 mb-4">
                    <v-card hover raised>
                        <router-link :to="'/classes/'+c.reference" id="wer">
                        ...
                        <v-card-title>
                            <v-layout row wrap>
                                <v-flex xs12 class="px-4 text-xs-center">
                                     <h2 class="font-weight-light"><span>Classes :</span> <span>{{c.classes.length}}</span></h2>
                                </v-flex>
                            </v-layout>
                        </v-card-title>
                        </router-link>
